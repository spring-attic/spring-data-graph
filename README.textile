...
This project has been deprecated, because the name has changed to Spring Data Neo4j. 
All active development is continuing in a 
fork at "Spring Data Neo4j":https://github.com/SpringSource/spring-data-neo4j .
